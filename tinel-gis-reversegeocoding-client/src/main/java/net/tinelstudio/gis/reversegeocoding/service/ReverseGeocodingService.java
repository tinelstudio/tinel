...
/**
 * Defines the client side of the Reverse Geocoding service.
 * 
 * @author TineL
 */
public interface ReverseGeocodingService {
  ...
  /**
   * Finds nearby geographical places specified by the given locator.
   * 
   ...
   */
  List<? extends Place> findNearest(Locator locator)
