 ...
 * only against street's country name. Only one street (usually first) per same
 * country is found.
 * 
 * @author TineL
 * @see Locator
 */
public class DistinctStreetByCountryLocator extends AbstractLocator {

  /** The <code>serialVersionUID</code>. */
  private static final long serialVersionUID=-6751696320511495903L;
}
