 ...
 * compared only against address'es country name. Only one address (usually
 * first) per same country is found.
 * 
 * @author TineL
 * @see Locator
 */
public class DistinctAddressByCountryLocator extends AbstractLocator {

  /** The <code>serialVersionUID</code>. */
  private static final long serialVersionUID=-134832362267887282L;
}
