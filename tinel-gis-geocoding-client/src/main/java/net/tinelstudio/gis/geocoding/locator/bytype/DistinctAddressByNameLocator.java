 ...
 * compared only against address'es name. Only one address (usually first) per
 * same name is found.
 * 
 * @author TineL
 * @see Locator
 */
public class DistinctAddressByNameLocator extends AbstractLocator {

  /** The <code>serialVersionUID</code>. */
  private static final long serialVersionUID=4007744886693622620L;
}
