...
package net.tinelstudio.commons.db.dao.hibernate;

import java.lang.reflect.ParameterizedType;
import java.util.Collection;
import java.util.List;

import net.tinelstudio.commons.db.dao.LoadSaveDeleteDao;
 ...
 */
@Transactional
public abstract class HibernateLoadSaveDeleteDao<E> extends HibernateDaoSupport
  implements LoadSaveDeleteDao<E> {

  /** The known domain class instead of generic E. */
  private Class<E> domainClass;

  @SuppressWarnings("unchecked")
  public HibernateLoadSaveDeleteDao() {
    /*
     * Trick: Get known domain class from generic. Works only with Java
     * reflection, but not with cglib for instance.
     */
